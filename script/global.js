...
$(function() {
  ...
  $(this).parents('.btn-group').find('.dropdown-toggle').html(selText+' <span class="caret"></span>');
	...
	$(".drop-down-featured li").on("click",function(){
	...
	$(".sharing-popup").on("click",function(){
		$(".large-popup.foodwallsharingmenu").slideToggle();
		return false;
	});

	$(".login-user-down").on("click",function(){
		$(".large-popup.foodwallmenu-me").slideToggle();
		return false;
	});

	$(".btn-wallsearch").on("click",function(){
		$(".large-popup.foodwallsearchmenu").slideToggle();
		return false;
	});
	...
	$(".large-popup.foodwallmenu-me .close-button").on("click", function(){
		$(".large-popup.foodwallmenu-me").slideUp();
	});

	$(".large-popup.foodwallsharingmenu .close-button").on("click", function(){
		$(".large-popup.foodwallsharingmenu").slideUp();
	});

	$(".large-popup.foodwallsearchmenu .close-button").on("click", function(){
		$(".large-popup.foodwallsearchmenu").slideUp();
	});
   ...
   $('#scrollspy').affix({
	...
	$(".s_keywords-search a").eq(0).on("click",function(){
		$(this).parent().find(".color-6").fadeOut();
	})

	$(".s_keywords-searchs a").eq(0).on("click",function(){
		$(this).parent().find(".color-6").fadeOut();
	})


	$(".s_keywords-search i").on("click",function(){
		if($(this).parent().index()!=0)
				$(this).parent().fadeOut();
	})

	$('.btn-search-key').click(function(){
            var value = $('#input-sign-search').val();
            var temp = '<a class="btn color-6 size-3 hover-10">'+value+'<i class="fa keyword fa-times"></i></a>';
            $('.sign-search-text').append(temp);
        });

	$('.btn-search-equipment-key').click(function(){
			      var value = $('#equipment-sign-search').val();
			      var temp = '<a class="btn color-6 size-3 hover-10">'+value+'<i class="fa keyword fa-times"></i></a>';
			      $('.sign-search-equipment-text').append(temp);
			  });
